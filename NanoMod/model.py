...
"""NanoMod-tRNA Model Module v0.9.6 (Attention MIL)

This module implements an Attention-based Multiple Instance Learning (MIL) model
...
- Site-level Aggregation: Weighted sum of read embeddings
- Output: [B,] site-level modification probability (0-1)

Features:
- 6 electrical signal features per read
- tRNA structure embedding (16-dim) for position encoding
- Attention weights indicate which reads are most informative
"""
